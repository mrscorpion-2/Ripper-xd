...
global.channelLink = "https://whatsapp.com/channel/0029Va90zAnIHphOuO8Msp";
global.ytch = "Mr Lwazi";
    ...
    try {
        ...
        if (message.message?.buttonsResponseMessage) {
            ...
            if (buttonId === 'channel') {
                ...
                await sock.sendMessage(chatId, {
                    text: `🔗 *Support*\n\nhttps://chat.whatsapp.com/GA4WrOFythU6g3BFVubYM7?mo`
                }, { quoted: message });
                return;
            }
        }
